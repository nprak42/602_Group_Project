...
This experiment investigates the relationship between the intensity of social capital and job-seeking confidence. The design follows a two-way factorial structure, where two independent variables (IVs) are manipulated: social capital rank and social capital closeness. Participants were asked to report their job-seeking confidence based on their social networks, and the effects of these two IVs on three outcome variables (job-seeking confidence) were analyzed.
...
The primary outcome variables (DVs) are three dimensions of job-seeking confidence:
 • DV1: Confidence in getting a job.
 • DV2: Confidence in the effectiveness of job-seeking strategies.
 • DV3: Confidence in coping with job-search challenges. These outcome variables are measured using Likert-scale survey responses, ranging from low to high confidence.
...
ggplot(exp_data) + 
  ...
  labs(title = "Distribution of DV1", x = "DV1 Levels", y = "Count")
